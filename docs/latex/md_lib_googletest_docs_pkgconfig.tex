...
All current build systems support pkg-\/config in one way or another. For all examples here we assume you want to compile the sample {\ttfamily samples/sample3\+\_\+unittest.\+cc}.\hypertarget{md_lib_googletest_docs_pkgconfig_autotoc_md223}{}\doxysubsection{C\+Make}\label{md_lib_googletest_docs_pkgconfig_autotoc_md223}
...
pkg-\/config will also try to look in {\ttfamily P\+K\+G\+\_\+\+C\+O\+N\+F\+I\+G\+\_\+\+P\+A\+TH} to find {\ttfamily gtest\+\_\+main.\+pc}.\hypertarget{md_lib_googletest_docs_pkgconfig_autotoc_md225}{}\doxysubsection{Using pkg-\/config in a cross-\/compilation setting}\label{md_lib_googletest_docs_pkgconfig_autotoc_md225}
