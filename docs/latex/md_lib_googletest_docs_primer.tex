\hypertarget{md_lib_googletest_docs_primer_autotoc_md231}{}\doxysection{Introduction\+: Why googletest?}\label{md_lib_googletest_docs_primer_autotoc_md231}
...
\end{longtabu}
\hypertarget{md_lib_googletest_docs_primer_autotoc_md233}{}\doxysection{Basic Concepts}\label{md_lib_googletest_docs_primer_autotoc_md233}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_lib_googletest_docs_primer_autotoc_md234}{}\doxysection{Assertions}\label{md_lib_googletest_docs_primer_autotoc_md234}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_lib_googletest_docs_primer_same-data-multiple-tests}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md_lib_googletest_docs_primer_same-data-multiple-tests}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_lib_googletest_docs_primer_autotoc_md236}{}\doxysection{Invoking the Tests}\label{md_lib_googletest_docs_primer_autotoc_md236}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_lib_googletest_docs_primer_autotoc_md237}{}\doxysection{Writing the main() Function}\label{md_lib_googletest_docs_primer_autotoc_md237}
...
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
\DoxyCodeLine{  // Class members declared here can be used by all unit-\/tests in the test suite}
...
\{\+: .callout .note\} N\+O\+TE\+: {\ttfamily Parse\+G\+Unit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_lib_googletest_docs_primer_autotoc_md238}{}\doxysection{Known Limitations}\label{md_lib_googletest_docs_primer_autotoc_md238}
