...
\{\+: .callout .note\} {\bfseries{Note\+:}} g\+Mock lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by g\+Mock. We omit such {\ttfamily using} statements in this section for brevity, but you should do it in your own code.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md124}{}\doxysection{Creating Mock Classes}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md124}
...
\end{DoxyItemize}\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md125}{}\doxysubsection{Dealing with unprotected commas}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md125}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md126}{}\doxysubsection{Mocking Private or Protected Methods}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md126}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md127}{}\doxysubsection{Mocking Overloaded Methods}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md127}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md128}{}\doxysubsection{Mocking Class Templates}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md128}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_MockingNonVirtualMethods}{}\doxysubsection{Mocking Non-\/virtual Methods}\label{md_lib_googletest_docs_gmock_cook_book_MockingNonVirtualMethods}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md129}{}\doxysubsection{Mocking Free Functions}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md129}
...
\end{longtabu}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_NiceStrictNaggy}{}\doxysubsection{The Nice, the Strict, and the Naggy}\label{md_lib_googletest_docs_gmock_cook_book_NiceStrictNaggy}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md131}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md131}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md_lib_googletest_docs_gmock_cook_book_DelegatingToFake}{}\doxysubsection{Delegating Calls to a Fake}\label{md_lib_googletest_docs_gmock_cook_book_DelegatingToFake}
...
(Why don\textquotesingle{}t we just write {\ttfamily \{ return foo.\+Concrete(str); \}}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md134}{}\doxysection{Using Matchers}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md134}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md135}{}\doxysubsection{Matching Argument Values Exactly}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md135}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md136}{}\doxysubsection{Using Simple Matchers}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md136}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_CombiningMatchers}{}\doxysubsection{Combining Matchers}\label{md_lib_googletest_docs_gmock_cook_book_CombiningMatchers}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_SafeMatcherCast}{}\doxysubsection{Casting Matchers}\label{md_lib_googletest_docs_gmock_cook_book_SafeMatcherCast}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md_lib_googletest_docs_gmock_cook_book_SelectOverload}{}\doxysubsection{Selecting Between Overloaded Functions}\label{md_lib_googletest_docs_gmock_cook_book_SelectOverload}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md137}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md137}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md138}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md138}
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args$<$0, 1$>$(Truly(\&\+My\+Predicate)))}), that predicate M\+U\+ST be written to take a {\ttfamily std\+::tuple} as its argument; g\+Mock will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md139}{}\doxysubsection{Using Matchers as Predicates}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md139}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md140}{}\doxysubsection{Using Matchers in googletest Assertions}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md140}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+T\+H\+AT}}} in the Assertions Reference.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md141}{}\doxysubsection{Using Predicates as Matchers}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md141}
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in in statement {\ttfamily if (condition) ...}.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md142}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md142}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}, or the result is undefined.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md143}{}\doxysubsection{Validating a Member of an Object}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md143}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md144}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md144}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md145}{}\doxysubsection{Testing a Certain Property of an Object}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md145}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md146}{}\doxysubsection{Matching Containers}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md146}
...
\end{DoxyItemize}\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md147}{}\doxysubsection{Sharing Matchers}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md147}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_PureMatchers}{}\doxysubsection{Matchers must have no side-\/effects}\label{md_lib_googletest_docs_gmock_cook_book_PureMatchers}
...
This requirement must be satisfied no matter how a matcher is defined (e.\+g., if it is one of the standard matchers, or a custom matcher). In particular, a matcher can never call a mock function, as that will affect the state of the mock object and g\+Mock.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md148}{}\doxysection{Setting Expectations}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md148}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_UseOnCall}{}\doxysubsection{Knowing When to Expect}\label{md_lib_googletest_docs_gmock_cook_book_UseOnCall}
...
Please note that once you expressed interest in a particular mock method (via {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} statement, it will be an error.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md150}{}\doxysubsection{Disallowing Unexpected Calls}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md150}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} statements will be an error.\hypertarget{md_lib_googletest_docs_gmock_cook_book_uninteresting-vs-unexpected}{}\doxysubsection{Understanding Uninteresting vs Unexpected Calls}\label{md_lib_googletest_docs_gmock_cook_book_uninteresting-vs-unexpected}
...
For more on uninteresting calls, nice mocks, and strict mocks, read \href{\#NiceStrictNaggy}{\texttt{ \char`\"{}\+The Nice, the Strict, and the Naggy\char`\"{}}}.\hypertarget{md_lib_googletest_docs_gmock_cook_book_ParameterlessExpectations}{}\doxysubsection{Ignoring Uninteresting Arguments}\label{md_lib_googletest_docs_gmock_cook_book_ParameterlessExpectations}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, g\+Mock will report an error.\hypertarget{md_lib_googletest_docs_gmock_cook_book_PartialOrder}{}\doxysubsection{Expecting Partially Ordered Calls}\label{md_lib_googletest_docs_gmock_cook_book_PartialOrder}
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md151}{}\doxysubsection{Controlling When an Expectation Retires}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md151}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md152}{}\doxysection{Using Actions}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md152}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md153}{}\doxysubsection{Returning References from Mock Methods}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md153}
...
\DoxyCodeLine{...}
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md154}{}\doxysubsection{Returning Live Values from Mock Methods}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md154}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md155}{}\doxysubsection{Combining Actions}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md155}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_SaveArgVerify}{}\doxysubsection{Verifying Complex Arguments}\label{md_lib_googletest_docs_gmock_cook_book_SaveArgVerify}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_MockingSideEffects}{}\doxysubsection{Mocking Side Effects}\label{md_lib_googletest_docs_gmock_cook_book_MockingSideEffects}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md156}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md156}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md_lib_googletest_docs_reference_mocking_DefaultValue}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md_lib_googletest_docs_reference_mocking_DefaultValue}
...
Please note that changing the default value for a type can make your tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md157}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md157}
...
precedence\char`\"{} rule, but they don\textquotesingle{}t interact. That is, {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+LL}s have their own precedence order distinct from the {\ttfamily O\+N\+\_\+\+C\+A\+LL} precedence order.\hypertarget{md_lib_googletest_docs_gmock_cook_book_FunctionsAsActions}{}\doxysubsection{Using Functions/\+Methods/\+Functors/\+Lambdas as Actions}\label{md_lib_googletest_docs_gmock_cook_book_FunctionsAsActions}
...
\end{DoxyItemize}\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md158}{}\doxysubsection{Using Functions with Extra Info as Actions}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md158}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md159}{}\doxysubsection{Invoking a Function/\+Method/\+Functor/\+Lambda/\+Callback Without Arguments}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md159}
...
\end{DoxyItemize}\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md160}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md160}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md161}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md161}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md_lib_googletest_docs_gmock_cook_book_SelectingArgs}{}\doxysubsection{Selecting an Action\textquotesingle{}s Arguments}\label{md_lib_googletest_docs_gmock_cook_book_SelectingArgs}
...
\end{DoxyItemize}\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md162}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md162}
...
\DoxyCodeLine{      .WillOnce(Invoke(DistanceToOrigin));}
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md163}{}\doxysubsection{Sharing Actions}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md163}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md164}{}\doxysubsection{Testing Asynchronous Behavior}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md164}
...
\{\+: .callout .note\} Note\+: this example has a downside\+: namely, if the expectation is not satisfied, our test will run forever. It will eventually time-\/out and fail, but it will take longer and be slightly harder to debug. To alleviate this problem, you can use {\ttfamily Wait\+For\+Notification\+With\+Timeout(ms)} instead of {\ttfamily Wait\+For\+Notification()}.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md165}{}\doxysection{Misc Recipes on Using g\+Mock}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md165}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md166}{}\doxysubsection{Mocking Methods That Use Move-\/\+Only Types}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md166}
...
A few actions (e.\+g. {\ttfamily Do\+All}) copy their arguments internally, so they can never work with non-\/copyable objects; you\textquotesingle{}ll have to use functors instead.\hypertarget{md_lib_googletest_docs_gmock_cook_book_LegacyMoveOnly}{}\doxysubsubsection{Legacy workarounds for move-\/only types}\label{md_lib_googletest_docs_gmock_cook_book_LegacyMoveOnly}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md167}{}\doxysubsection{Making the Compilation Faster}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md167}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md168}{}\doxysubsection{Forcing a Verification}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md168}
...
And that\textquotesingle{}s that.\hypertarget{md_lib_googletest_docs_gmock_cook_book_UsingThreads}{}\doxysubsection{Using g\+Mock and Threads}\label{md_lib_googletest_docs_gmock_cook_book_UsingThreads}
...
Also, remember that {\ttfamily Default\+Value$<$T$>$} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md170}{}\doxysubsection{Controlling How Much Information g\+Mock Prints}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md170}
...
Now, judiciously use the right flag to enable g\+Mock serve you better!\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md171}{}\doxysubsection{Gaining Super Vision into Mock Calls}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md171}
...
If you are interested in the mock call trace but not the stack traces, you can combine {\ttfamily -\/-\/gmock\+\_\+verbose=info} with {\ttfamily -\/-\/gtest\+\_\+stack\+\_\+trace\+\_\+depth=0} on the test command line.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md172}{}\doxysubsection{Running Tests in Emacs}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md172}
...
Then you can type {\ttfamily M-\/m} to start a build (if you want to run the test as well, just make sure {\ttfamily foo\+\_\+test.\+run} or {\ttfamily runtests} is in the build command you supply after typing {\ttfamily M-\/m}), or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md173}{}\doxysection{Extending g\+Mock}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md173}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_NewMatchers}{}\doxysubsection{Writing New Matchers Quickly}\label{md_lib_googletest_docs_gmock_cook_book_NewMatchers}
...
\{\+: .callout .tip\} Tip\+: for convenience, {\ttfamily Match\+And\+Explain()} can take a {\ttfamily Match\+Result\+Listener$\ast$} instead of {\ttfamily std\+::ostream$\ast$}.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md176}{}\doxysubsection{Writing New Polymorphic Matchers}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md176}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md177}{}\doxysubsection{Legacy Matcher Implementation}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md177}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md178}{}\doxysubsection{Writing New Cardinalities}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md178}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_QuickNewActions}{}\doxysubsection{Writing New Actions Quickly}\label{md_lib_googletest_docs_gmock_cook_book_QuickNewActions}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md179}{}\doxysubsubsection{Legacy macro-\/based Actions}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md179}
...
\end{longtabu}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md180}{}\doxysubsubsection{Legacy macro-\/based parameterized Actions}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md180}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md181}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an A\+C\+T\+I\+ON}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md181}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in googletest that verifies two types are the same.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md182}{}\doxysubsection{Writing New Action Templates Quickly}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md182}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md183}{}\doxysubsection{Using the A\+C\+T\+I\+O\+N Object\textquotesingle{}s Type}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md183}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md_lib_googletest_docs_gmock_cook_book_NewMonoActions}{}\doxysubsection{Writing New Monomorphic Actions}\label{md_lib_googletest_docs_gmock_cook_book_NewMonoActions}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_NewPolyActions}{}\doxysubsection{Writing New Polymorphic Actions}\label{md_lib_googletest_docs_gmock_cook_book_NewPolyActions}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md184}{}\doxysubsection{Teaching g\+Mock How to Print Your Values}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md184}
...
This printer knows how to print built-\/in C++ types, native arrays, S\+TL containers, and any type that supports the {\ttfamily $<$$<$} operator. For other types, it prints the raw bytes in the value and hopes that you the user can figure it out. \href{advanced.md\#teaching-googletest-how-to-print-your-values}{\texttt{ The Google\+Test advanced guide}} explains how to extend the printer to do a better job at printing your particular type than to dump the bytes.\hypertarget{md_lib_googletest_docs_gmock_cook_book_autotoc_md185}{}\doxysection{Useful Mocks Created Using g\+Mock}\label{md_lib_googletest_docs_gmock_cook_book_autotoc_md185}
\hypertarget{md_lib_googletest_docs_gmock_cook_book_MockFunction}{}\doxysubsection{Mock std\+::function}\label{md_lib_googletest_docs_gmock_cook_book_MockFunction}
