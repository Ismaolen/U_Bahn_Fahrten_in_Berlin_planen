\hypertarget{md_lib_googletest_docs_advanced_autotoc_md16}{}\doxysection{Introduction}\label{md_lib_googletest_docs_advanced_autotoc_md16}
Now that you have read the googletest Primer and learned how to write tests using googletest, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md17}{}\doxysection{More Assertions}\label{md_lib_googletest_docs_advanced_autotoc_md17}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md18}{}\doxysubsection{Explicit Success and Failure}\label{md_lib_googletest_docs_advanced_autotoc_md18}
See \href{reference/assertions.md\#success-failure}{\texttt{ Explicit Success and Failure}} in the Assertions Reference.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md19}{}\doxysubsection{Exception Assertions}\label{md_lib_googletest_docs_advanced_autotoc_md19}
See \href{reference/assertions.md\#exceptions}{\texttt{ Exception Assertions}} in the Assertions Reference.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md20}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_lib_googletest_docs_advanced_autotoc_md20}
...
googletest gives you three different options to solve this problem\+:\hypertarget{md_lib_googletest_docs_advanced_autotoc_md21}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_lib_googletest_docs_advanced_autotoc_md21}
If you already have a function or functor that returns {\ttfamily bool} (or a type that can be implicitly converted to {\ttfamily bool}), you can use it in a {\itshape predicate assertion} to get the function arguments printed for free. See \href{reference/assertions.md\#EXPECT_PRED}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+P\+R\+E\+D$\ast$}}} in the Assertions Reference for details.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md22}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_lib_googletest_docs_advanced_autotoc_md22}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_advanced_autotoc_md23}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_lib_googletest_docs_advanced_autotoc_md23}
If you find the default message generated by \href{reference/assertions.md\#EXPECT_PRED}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+P\+R\+E\+D$\ast$}}} and \href{reference/assertions.md\#EXPECT_TRUE}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+T\+R\+UE}}} unsatisfactory, or some arguments to your predicate do not support streaming to {\ttfamily ostream}, you can instead use {\itshape predicate-\/formatter assertions} to {\itshape fully} customize how the message is formatted. See \href{reference/assertions.md\#EXPECT_PRED_FORMAT}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+P\+R\+E\+D\+\_\+\+F\+O\+R\+M\+A\+T$\ast$}}} in the Assertions Reference for details.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md24}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_lib_googletest_docs_advanced_autotoc_md24}
See \href{reference/assertions.md\#floating-point}{\texttt{ Floating-\/\+Point Comparison}} in the Assertions Reference.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md25}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_lib_googletest_docs_advanced_autotoc_md25}
...
The above code verifies that {\ttfamily val1} is less than, or approximately equal to, {\ttfamily val2}.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md26}{}\doxysubsection{Asserting Using g\+Mock Matchers}\label{md_lib_googletest_docs_advanced_autotoc_md26}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+T\+H\+AT}}} in the Assertions Reference.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md27}{}\doxysubsection{More String Assertions}\label{md_lib_googletest_docs_advanced_autotoc_md27}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_advanced_autotoc_md28}{}\doxysubsection{Windows H\+R\+E\+S\+U\+L\+T assertions}\label{md_lib_googletest_docs_advanced_autotoc_md28}
See \href{reference/assertions.md\#HRESULT}{\texttt{ Windows H\+R\+E\+S\+U\+LT Assertions}} in the Assertions Reference.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md29}{}\doxysubsection{Type Assertions}\label{md_lib_googletest_docs_advanced_autotoc_md29}
...
to cause a compiler error.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md30}{}\doxysubsection{Assertion Placement}\label{md_lib_googletest_docs_advanced_autotoc_md30}
...
{\ttfamily G\+T\+E\+S\+T\+\_\+\+S\+K\+I\+P()} can be used in individual test cases or in the {\ttfamily Set\+Up()} methods of classes derived from either {\ttfamily \mbox{\hyperlink{classtesting_1_1_environment}{testing\+::\+Environment}}} or {\ttfamily \mbox{\hyperlink{classtesting_1_1_test}{testing\+::\+Test}}}. For example\+:
...
\DoxyCodeLine{    GTEST\_SKIP() << "Skipping all unit-\/tests for this fixture";}
\DoxyCodeLine{  \}}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
...
As with assertion macros, you can stream a custom message into {\ttfamily G\+T\+E\+S\+T\+\_\+\+S\+K\+I\+P()}.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md32}{}\doxysection{Teaching googletest How to Print Your Values}\label{md_lib_googletest_docs_advanced_autotoc_md32}
...
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_advanced_autotoc_md33}{}\doxysection{Death Tests}\label{md_lib_googletest_docs_advanced_autotoc_md33}
...
If you want to test {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()/\+A\+S\+S\+E\+R\+T\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ \char`\"{}\+Catching\char`\"{} Failures}}.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md34}{}\doxysubsection{How to Write a Death Test}\label{md_lib_googletest_docs_advanced_autotoc_md34}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_advanced_autotoc_md36}{}\doxysubsection{Regular Expression Syntax}\label{md_lib_googletest_docs_advanced_autotoc_md36}
...
To help you determine which capability is available on your system, googletest defines macros to govern which regular expression it is using. The macros are\+: {\ttfamily G\+T\+E\+S\+T\+\_\+\+U\+S\+E\+S\+\_\+\+S\+I\+M\+P\+L\+E\+\_\+\+RE=1} or {\ttfamily G\+T\+E\+S\+T\+\_\+\+U\+S\+E\+S\+\_\+\+P\+O\+S\+I\+X\+\_\+\+RE=1}. If you want your death tests to work in all cases, you can either {\ttfamily \#if} on these macros or use the more limited syntax only.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md37}{}\doxysubsection{How It Works}\label{md_lib_googletest_docs_advanced_autotoc_md37}
See \href{reference/assertions.md\#death}{\texttt{ Death Assertions}} in the Assertions Reference.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md38}{}\doxysubsection{Death Tests And Threads}\label{md_lib_googletest_docs_advanced_autotoc_md38}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md39}{}\doxysubsection{Death Test Styles}\label{md_lib_googletest_docs_advanced_autotoc_md39}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_advanced_autotoc_md40}{}\doxysubsection{Caveats}\label{md_lib_googletest_docs_advanced_autotoc_md40}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md41}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_lib_googletest_docs_advanced_autotoc_md41}
\{\+: .callout .note\} Note\+: If you want to put a series of test assertions in a subroutine to check for a complex condition, consider using \href{gmock_cook_book.md\#NewMatchers}{\texttt{ a custom G\+Mock matcher}} instead. This lets you provide a more readable error message in case of failure and avoid all of the issues described below.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md42}{}\doxysubsection{Adding Traces to Assertions}\label{md_lib_googletest_docs_advanced_autotoc_md42}
...
\end{DoxyEnumerate}\hypertarget{md_lib_googletest_docs_advanced_autotoc_md43}{}\doxysubsection{Propagating Fatal Failures}\label{md_lib_googletest_docs_advanced_autotoc_md43}
...
This listener should be added after other listeners if you have any, otherwise they won\textquotesingle{}t see failed {\ttfamily On\+Test\+Part\+Result}.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md45}{}\doxysubsubsection{Asserting on Subroutines}\label{md_lib_googletest_docs_advanced_autotoc_md45}
...
Assertions from multiple threads are currently not supported on Windows.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md46}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_lib_googletest_docs_advanced_autotoc_md46}
...
Similarly, {\ttfamily Has\+Nonfatal\+Failure()} returns {\ttfamily true} if the current test has at least one non-\/fatal failure, and {\ttfamily Has\+Failure()} returns {\ttfamily true} if the current test has at least one failure of either kind.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md47}{}\doxysection{Logging Additional Information}\label{md_lib_googletest_docs_advanced_autotoc_md47}
...
\hypertarget{md_lib_googletest_docs_advanced_autotoc_md48}{}\doxysection{Sharing Resources Between Tests in the Same Test Suite}\label{md_lib_googletest_docs_advanced_autotoc_md48}
...
\DoxyCodeLine{}
\DoxyCodeLine{  // Some expensive resource shared by all unit-\/tests.}
...
\{\+: .callout .note\} N\+O\+TE\+: Though the above code declares {\ttfamily Set\+Up\+Test\+Suite()} protected, it may sometimes be necessary to declare it public, such as when using it with {\ttfamily T\+E\+S\+T\+\_\+P}.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md49}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_lib_googletest_docs_advanced_autotoc_md49}
...
\end{DoxyItemize}\hypertarget{md_lib_googletest_docs_advanced_autotoc_md51}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_lib_googletest_docs_advanced_autotoc_md51}
...
You can see \href{https://github.com/google/googletest/blob/master/googletest/samples/sample7_unittest.cc}{\texttt{ sample7\+\_\+unittest.\+cc}} and \href{https://github.com/google/googletest/blob/master/googletest/samples/sample8_unittest.cc}{\texttt{ sample8\+\_\+unittest.\+cc}} for more examples.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md52}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_lib_googletest_docs_advanced_autotoc_md52}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily I\+N\+S\+T\+A\+N\+T\+I\+A\+T\+E\+\_\+\+T\+E\+S\+T\+\_\+\+S\+U\+I\+T\+E\+\_\+\+P()}, and depending on the library target that contains {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test suite multiple times, possibly in different source files.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md53}{}\doxysubsection{Specifying Names for Value-\/\+Parameterized Test Parameters}\label{md_lib_googletest_docs_advanced_autotoc_md53}
...
\DoxyCodeLine{    \});}
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_advanced_autotoc_md54}{}\doxysection{Typed Tests}\label{md_lib_googletest_docs_advanced_autotoc_md54}
...
You can see \href{https://github.com/google/googletest/blob/master/googletest/samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md55}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_lib_googletest_docs_advanced_autotoc_md55}
...
You can see \href{https://github.com/google/googletest/blob/master/googletest/samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md56}{}\doxysection{Testing Private Code}\label{md_lib_googletest_docs_advanced_autotoc_md56}
...
\} // namespace my\+\_\+namespace \`{}\`{}\`{}
\end{DoxyItemize}\hypertarget{md_lib_googletest_docs_advanced_autotoc_md57}{}\doxysection{\char`\"{}\+Catching\char`\"{} Failures}\label{md_lib_googletest_docs_advanced_autotoc_md57}
...
\end{DoxyEnumerate}\hypertarget{md_lib_googletest_docs_advanced_autotoc_md58}{}\doxysection{Registering tests programmatically}\label{md_lib_googletest_docs_advanced_autotoc_md58}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_advanced_autotoc_md59}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_lib_googletest_docs_advanced_autotoc_md59}
...
{\ttfamily current\+\_\+test\+\_\+info()} returns a null pointer if no test is running. In particular, you cannot find the test suite name in {\ttfamily Set\+Up\+Test\+Suite()}, {\ttfamily Tear\+Down\+Test\+Suite()} (where you know the test suite name implicitly), or functions called from them.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md60}{}\doxysection{Extending googletest by Handling Test Events}\label{md_lib_googletest_docs_advanced_autotoc_md60}
googletest provides an {\bfseries{event listener A\+PI}} to let you receive notifications about the progress of a test program and test failures. The events you can listen to include the start and end of the test program, a test suite, or a test method, among others. You may use this A\+PI to augment or replace the standard console output, replace the X\+ML output, or provide a completely different form of output, such as a G\+UI or a database. You can also use test events as checkpoints to implement a resource leak checker, for example.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md61}{}\doxysubsection{Defining Event Listeners}\label{md_lib_googletest_docs_advanced_autotoc_md61}
...
\DoxyCodeLine{ \};}
\end{DoxyCode}
\hypertarget{md_lib_googletest_docs_advanced_autotoc_md62}{}\doxysubsection{Using Event Listeners}\label{md_lib_googletest_docs_advanced_autotoc_md62}
...
See \href{https://github.com/google/googletest/blob/master/googletest/samples/sample10_unittest.cc}{\texttt{ sample10\+\_\+unittest.\+cc}} for an example of a failure-\/raising listener.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md64}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_lib_googletest_docs_advanced_autotoc_md64}
...
If an option is specified both by an environment variable and by a flag, the latter takes precedence.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md65}{}\doxysubsection{Selecting Tests}\label{md_lib_googletest_docs_advanced_autotoc_md65}
\hypertarget{md_lib_googletest_docs_advanced_autotoc_md66}{}\doxysubsubsection{Listing Test Names}\label{md_lib_googletest_docs_advanced_autotoc_md66}
...
None of the tests listed are actually run if the flag is provided. There is no corresponding environment variable for this flag.\hypertarget{md_lib_googletest_docs_advanced_autotoc_md67}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_lib_googletest_docs_advanced_autotoc_md67}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md68}{}\doxysubsubsection{Stop test execution upon first failure}\label{md_lib_googletest_docs_advanced_autotoc_md68}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md69}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_lib_googletest_docs_advanced_autotoc_md69}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md70}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_lib_googletest_docs_advanced_autotoc_md70}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md71}{}\doxysubsection{Repeating the Tests}\label{md_lib_googletest_docs_advanced_autotoc_md71}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md72}{}\doxysubsection{Shuffling the Tests}\label{md_lib_googletest_docs_advanced_autotoc_md72}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md73}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_lib_googletest_docs_advanced_autotoc_md73}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md74}{}\doxysubsection{Controlling Test Output}\label{md_lib_googletest_docs_advanced_autotoc_md74}
{\itshape  }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md75}{}\doxysubsubsection{Colored Terminal Output}\label{md_lib_googletest_docs_advanced_autotoc_md75}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md76}{}\doxysubsubsection{Suppressing test passes}\label{md_lib_googletest_docs_advanced_autotoc_md76}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md77}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_lib_googletest_docs_advanced_autotoc_md77}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md78}{}\doxysubsubsection{Suppressing U\+T\+F-\/8 Text Output}\label{md_lib_googletest_docs_advanced_autotoc_md78}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md79}{}\doxysubsubsection{Generating an X\+M\+L Report}\label{md_lib_googletest_docs_advanced_autotoc_md79}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md80}{}\doxysubsubsection{Generating a J\+S\+O\+N Report}\label{md_lib_googletest_docs_advanced_autotoc_md80}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md81}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_lib_googletest_docs_advanced_autotoc_md81}
{\itshape  }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md82}{}\doxysubsubsection{Detecting Test Premature Exit}\label{md_lib_googletest_docs_advanced_autotoc_md82}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md83}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_lib_googletest_docs_advanced_autotoc_md83}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md84}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_lib_googletest_docs_advanced_autotoc_md84}
...
{\itshape }\hypertarget{md_lib_googletest_docs_advanced_autotoc_md85}{}\doxysubsection{Sanitizer Integration}\label{md_lib_googletest_docs_advanced_autotoc_md85}
