...
\end{longtabu}
\hypertarget{md_lib_googletest_docs_reference_actions_autotoc_md251}{}\doxysection{Side Effects}\label{md_lib_googletest_docs_reference_actions_autotoc_md251}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_lib_googletest_docs_reference_actions_autotoc_md252}{}\doxysection{Using a Function, Functor, or Lambda as an Action}\label{md_lib_googletest_docs_reference_actions_autotoc_md252}
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_lib_googletest_docs_reference_actions_autotoc_md253}{}\doxysection{Default Action}\label{md_lib_googletest_docs_reference_actions_autotoc_md253}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
\{\+: .callout .note\} {\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_lib_googletest_docs_reference_actions_autotoc_md254}{}\doxysection{Composite Actions}\label{md_lib_googletest_docs_reference_actions_autotoc_md254}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action }&\cellcolor{\tableheadbgcolor}\textbf{ Description  }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_lib_googletest_docs_reference_actions_autotoc_md255}{}\doxysection{Defining Actions}\label{md_lib_googletest_docs_reference_actions_autotoc_md255}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
