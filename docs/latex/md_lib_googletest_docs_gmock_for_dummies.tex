\hypertarget{md_lib_googletest_docs_gmock_for_dummies_autotoc_md206}{}\doxysection{What Is g\+Mock?}\label{md_lib_googletest_docs_gmock_for_dummies_autotoc_md206}
...
\end{DoxyEnumerate}\hypertarget{md_lib_googletest_docs_gmock_for_dummies_autotoc_md207}{}\doxysection{Why g\+Mock?}\label{md_lib_googletest_docs_gmock_for_dummies_autotoc_md207}
...
\end{DoxyItemize}\hypertarget{md_lib_googletest_docs_gmock_for_dummies_autotoc_md208}{}\doxysection{Getting Started}\label{md_lib_googletest_docs_gmock_for_dummies_autotoc_md208}
g\+Mock is bundled with googletest.\hypertarget{md_lib_googletest_docs_gmock_for_dummies_autotoc_md209}{}\doxysection{A Case for Mock Turtles}\label{md_lib_googletest_docs_gmock_for_dummies_autotoc_md209}
...
You don\textquotesingle{}t need to define these mock methods somewhere else -\/ the {\ttfamily M\+O\+C\+K\+\_\+\+M\+E\+T\+H\+OD} macro will generate the definitions for you. It\textquotesingle{}s that simple!\hypertarget{md_lib_googletest_docs_gmock_for_dummies_autotoc_md212}{}\doxysubsection{Where to Put It}\label{md_lib_googletest_docs_gmock_for_dummies_autotoc_md212}
...
Admittedly, this test is contrived and doesn\textquotesingle{}t do much. You can easily achieve the same effect without using g\+Mock. However, as we shall reveal soon, g\+Mock allows you to do {\itshape so much more} with the mocks.\hypertarget{md_lib_googletest_docs_gmock_for_dummies_autotoc_md214}{}\doxysection{Setting Expectations}\label{md_lib_googletest_docs_gmock_for_dummies_autotoc_md214}
...
right.\char`\"{}\hypertarget{md_lib_googletest_docs_gmock_for_dummies_autotoc_md215}{}\doxysubsection{General Syntax}\label{md_lib_googletest_docs_gmock_for_dummies_autotoc_md215}
...
This works for all non-\/overloaded methods; if a method is overloaded, you need to help g\+Mock resolve which overload is expected by specifying the number of arguments and possibly also the \href{gmock_cook_book.md\#SelectOverload}{\texttt{ types of the arguments}}.\hypertarget{md_lib_googletest_docs_gmock_for_dummies_autotoc_md217}{}\doxysubsection{Cardinalities\+: How Many Times Will It Be Called?}\label{md_lib_googletest_docs_gmock_for_dummies_autotoc_md217}
...
{\bfseries{Quick quiz\+:}} what do you think will happen if a function is expected to be called twice but actually called four times?\hypertarget{md_lib_googletest_docs_gmock_for_dummies_autotoc_md218}{}\doxysubsection{Actions\+: What Should It Do?}\label{md_lib_googletest_docs_gmock_for_dummies_autotoc_md218}
...
(What if you care about the relative order of some of the calls, but not all of them? Can you specify an arbitrary partial order? The answer is ... yes! The details can be found \href{gmock_cook_book.md\#OrderedCalls}{\texttt{ here}}.)\hypertarget{md_lib_googletest_docs_gmock_for_dummies_StickyExpectations}{}\doxysubsection{All Expectations Are Sticky (\+Unless Said Otherwise)}\label{md_lib_googletest_docs_gmock_for_dummies_StickyExpectations}
