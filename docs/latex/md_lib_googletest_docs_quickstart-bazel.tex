This tutorial aims to get you up and running with Google\+Test using the Bazel build system. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point.\hypertarget{md_lib_googletest_docs_quickstart-bazel_autotoc_md240}{}\doxysection{Prerequisites}\label{md_lib_googletest_docs_quickstart-bazel_autotoc_md240}
...
\{\+: .callout .note\} Note\+: The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md_lib_googletest_docs_quickstart-bazel_autotoc_md241}{}\doxysection{Set up a Bazel workspace}\label{md_lib_googletest_docs_quickstart-bazel_autotoc_md241}
...
Now you\textquotesingle{}re ready to build C++ code that uses Google\+Test.\hypertarget{md_lib_googletest_docs_quickstart-bazel_autotoc_md242}{}\doxysection{Create and run a binary}\label{md_lib_googletest_docs_quickstart-bazel_autotoc_md242}
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md_lib_googletest_docs_quickstart-bazel_autotoc_md243}{}\doxysection{Next steps}\label{md_lib_googletest_docs_quickstart-bazel_autotoc_md243}
