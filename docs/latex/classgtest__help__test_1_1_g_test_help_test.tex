...
\begin{DoxyVerb}Verifies that the unit-tests are run and no help message is printed when
...
\begin{DoxyVerb}Verifies that when no help flag is specified, the unit-tests are run
and the help message is not printed.\end{DoxyVerb}
 

The documentation for this class was generated from the following file\+:\begin{DoxyCompactItemize}
\item 
lib/googletest/googletest/test/gtest\+\_\+help\+\_\+test.\+py\end{DoxyCompactItemize}
